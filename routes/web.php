...
Route::get('/liste-contact', [AdminController::class, 'liste_contact'])->name('liste-contact');
...
Route::get('/projets-réalisés', [HomeController::class, 'projet'])->name('projet.index');
